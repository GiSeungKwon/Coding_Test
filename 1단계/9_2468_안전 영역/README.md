    ...
    <div class="col-md-12">
        <section id="description" class="problem-section">
            ...
            <div id="problem_description" class="problem-text">
                ...
                <p><img alt="" src="./1.png" style="width: 290px; height: 250px; "></p>
                <p>이제 위와 같은 지역에 많은 비가 내려서 높이가 4 이하인 모든 지점이 물에 잠겼다고 하자. 이 경우에 물에 잠기는 지점을 회색으로 표시하면 다음과 같다. </p>
                <p><img alt="" src="./2.png" style="width: 290px; height: 250px; "></p>
                ...
                <p><img alt="" src="./3.png" style="width: 290px; height: 250px; "></p>
